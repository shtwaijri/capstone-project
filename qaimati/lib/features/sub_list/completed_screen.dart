            ...
            appBar: AppBar(
              ...
              leading: IconButton(
                ...
                onPressed: () => Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => SubListScreen()),
                ),
              ),
            ),
            body: BlocBuilder<SubListBloc, SubListState>(
              builder: (context, state) {
                ...
                // ⭐️ التعامل الصحيح مع حالة CompletedItemsLoadedState
                  ...
                  final completedItemsByListName =
                      bloc.completedItemsMap;
                  final listNames = completedItemsByListName.keys.toList();

                  if (listNames.isEmpty) {
                    return Center(
                      child: Text("No completed items found.".tr()),
                    );
                  }
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, listIndex) {
                      ...
                      final itemsInThisList =
                          completedItemsByListName[listName]!;
